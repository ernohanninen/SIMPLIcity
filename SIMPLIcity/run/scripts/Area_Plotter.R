#Source: https://github.com/ciccalab/SIMPLI/blob/master/scripts/Area_Plotter.R
#Code is from SIMPLI github page
#Updated by Erno Hänninen
#Since 23 March 2022
#THe change: plot also png files
...
if(n_categories == 2){
	...
	for (mm in main_markers){
		...
		multi_pdf_plotter(plots = area_boxplots[[mm]], filenamePng = file.path(boxplot_output_folder,
			paste0(mm, "_boxplots.png")), filenamePdf = file.path(boxplot_output_folder, paste0(mm, "_boxplots.pdf")))
	}
}
