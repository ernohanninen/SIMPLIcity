#Source: https://github.com/ciccalab/SIMPLI/blob/master/scripts/Permuted_spatial_plotting.R
...
for (my_pair in pairs){
	...
	if(n_categories >= 1){
		...
		multi_pdf_plotter(filenamePdf = paste0(out_dir, "/", my_pair, "-category-heterotypic_permutations.pdf"), filenamePng = paste0(out_dir, "/", my_pair, "-category-heterotypic_permutations.png"),
