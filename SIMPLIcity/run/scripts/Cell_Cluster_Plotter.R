#Source: https://github.com/ciccalab/SIMPLI/blob/master/scripts/Cell_Cluster_Plotter.R
...
for(res in resolutions){
	multi_pdf_plotter(c(list(umap_cluster_plots[[res]]), list(umap_sample_plots[[res]]), umap_marker_plots[[res]]),
		filenamePdf = file.path(umap_output_folder, paste0("UMAPs-", res, ".pdf")), filenamePng = file.path(umap_output_folder, paste0("UMAPs-", res, ".png"))) 
