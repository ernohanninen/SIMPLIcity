...
%SEE: https://monuseg.grand-challenge.org/Data/

function [binary_mask,color_mask]=he_to_binary_mask(filename)
    %im_file=strcat(filename,'.tif');
    
    %xml_file=strcat(filename,'.xml'); 
    im_file='/home/ernohanninen/ResearchProject/SIMPLI/MoNuSeg/images/TCGA-XS-A8TJ-01Z-00-DX1.tif'
    xml_file='/home/ernohanninen/ResearchProject/SIMPLI/MoNuSeg/raw_annotations/TCGA-XS-A8TJ-01Z-00-DX1.xml'
