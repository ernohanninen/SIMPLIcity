...
print(sample_names)
#print(clustering_data$Metadata_sample_name)
print(unique(clustering_data$Metadata_sample_name))
...
print(clustering_data_by_sample)
